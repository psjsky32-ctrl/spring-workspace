...
<div class="grid view" data-article-id="${article.id}">
	...
	<span>내용</span>
	<!--<pre> ==> Presentation 텍스트의 원문 그대로 표현한다-->
	...
	<template class="reply-item-template">
		<li class="reply-item" data-reply-id="#replyId#">
			<div class="writer">
				...
				추천수: <span class="recommend-count">#recommendCount#</span>
			</div>
			<div class="dates">
			...
			<div class="links">
				...
				<span class="links-update">수    정</span> <span class="links-delete">삭제</span>
			</div>
		</li>
	</template>
	...
	<div class="btn-group">
		<div class="right-align">
		  <sec:authorize access="hasAnyRole('RL-20260414-000001','RL-20260414-000003')" var="admin"/>
		  <sec:authorize access="isAuthenticated()"/>
		    <sec:authentication property="principal.email" var="loginUser"/>
			<c:if test="${admin or loginUser eq article.email}">
